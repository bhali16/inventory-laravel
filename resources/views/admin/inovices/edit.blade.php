...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.inovice.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.inovices.update", [$inovice->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="order_no">{{ trans('cruds.inovice.fields.order_no') }}</label>
                <input class="form-control {{ $errors->has('order_no') ? 'is-invalid' : '' }}" type="text" name="order_no" id="order_no" value="{{ old('order_no', $inovice->order_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('invoice_date') ? 'is-invalid' : '' }}" type="text" name="invoice_date" id="invoice_date" value="{{ old('invoice_date', $inovice->invoice_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_method') ? 'is-invalid' : '' }}" type="text" name="delivery_method" id="delivery_method" value="{{ old('delivery_method', $inovice->delivery_method) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account') ? 'is-invalid' : '' }}" type="text" name="account" id="account" value="{{ old('account', $inovice->account) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_name') ? 'is-invalid' : '' }}" type="text" name="job_name" id="job_name" value="{{ old('job_name', $inovice->job_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch') ? 'is-invalid' : '' }}" type="text" name="branch" id="branch" value="{{ old('branch', $inovice->branch) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_address') ? 'is-invalid' : '' }}" type="text" name="delivery_address" id="delivery_address" value="{{ old('delivery_address', $inovice->delivery_address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_phone') ? 'is-invalid' : '' }}" type="text" name="delivery_phone" id="delivery_phone" value="{{ old('delivery_phone', $inovice->delivery_phone) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('billing_address') ? 'is-invalid' : '' }}" type="text" name="billing_address" id="billing_address" value="{{ old('billing_address', $inovice->billing_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('billing_phone') ? 'is-invalid' : '' }}" type="text" name="billing_phone" id="billing_phone" value="{{ old('billing_phone', $inovice->billing_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" type="text" name="notes" id="notes" value="{{ old('notes', $inovice->notes) }}">
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('items_ordereds') ? 'is-invalid' : '' }}" name="items_ordereds[]" id="items_ordereds" multiple>
                    @foreach($items_ordereds as $id => $items_ordered)
                        <option value="{{ $id }}" {{ (in_array($id, old('items_ordereds', [])) || $inovice->items_ordereds->contains($id)) ? 'selected' : '' }}>{{ $items_ordered }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtotal') ? 'is-invalid' : '' }}" type="number" name="subtotal" id="subtotal" value="{{ old('subtotal', $inovice->subtotal) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax') ? 'is-invalid' : '' }}" type="number" name="tax" id="tax" value="{{ old('tax', $inovice->tax) }}" step="0.01">
                @if($errors->has('tax'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tax') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_charges') ? 'is-invalid' : '' }}" type="number" name="delivery_charges" id="delivery_charges" value="{{ old('delivery_charges', $inovice->delivery_charges) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('freight') ? 'is-invalid' : '' }}" type="number" name="freight" id="freight" value="{{ old('freight', $inovice->freight) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('handling') ? 'is-invalid' : '' }}" type="number" name="handling" id="handling" value="{{ old('handling', $inovice->handling) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('restocking') ? 'is-invalid' : '' }}" type="number" name="restocking" id="restocking" value="{{ old('restocking', $inovice->restocking) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_charges') ? 'is-invalid' : '' }}" type="number" name="other_charges" id="other_charges" value="{{ old('other_charges', $inovice->other_charges) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" type="number" name="total" id="total" value="{{ old('total', $inovice->total) }}" step="0.01" required>
                @if($errors->has('total'))
                    <div class="invalid-feedback">
                        {{ $errors->first('total') }}
                    </div>
