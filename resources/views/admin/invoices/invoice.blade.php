                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <span class="text-600 text-110 text-blue align-middle">{{$invoice->account}}</span>
                                    </div>

                                    <div class="text-grey-m2">
                                        <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Order No:</span> {{$invoice->order_no}}</div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm" id="productTable">
                                        ...
                                        <tr class="text-right">
                                            ...
                                            <td><h4 id="total_subtotal_price">{{$invoice->subtotal}}</h4></td>
                                        </tr>
                                        <tr class="text-right">
                                            <td colspan="3" ><h4>Shipping</h4></td>
                                            <td><h4 id="total_shipping_price">{{$invoice->delivery_charges}}</h4></td>
                                        </tr>

                                        <tr class="text-right">
                                            <td colspan="3" ><h4>Total</h4></td>
                                            <td><h1 id="total_price">{{$invoice->total}}</h1></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
