    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_code') ? 'is-invalid' : '' }}" type="number" name="product_code" id="product_code" value="{{ old('product_code', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_mfg') ? 'is-invalid' : '' }}" type="text" name="product_mfg" id="product_mfg" value="{{ old('product_mfg', '') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Product::PRODUCT_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('product_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="product_type_{{ $key }}" name="product_type" value="{{ $key }}" {{ old('product_type', '0') === (string) $key ? 'checked' : '' }} required>
